      ...
      if (lv.getY() <= lv2.getBottomY() + 4) {
            ...
            for(t = 0; t < 16; ++t) {
               for(u = 0; u < 8; ++u) {
                  ...
                  if (v) {
                     ...
                     if (u < 4 && !lv6.isSolid() && lv2.getBlockState(lv.add(s, u, t)) != lv5) {
                        return false;
                     }
                  }
               }
         ...
         for(s = 0; s < 16; ++s) {
            for(t = 0; t < 16; ++t) {
               for(u = 0; u < 8; ++u) {
                  if (bls[(s * 16 + t) * 8 + u]) {
                     BlockPos lv7 = lv.add(s, u, t);
                     if (this.canReplace(lv2.getBlockState(lv7))) {
                        bl2 = u >= 4;
               ...
               for(u = 0; u < 16; ++u) {
                  for(int v = 0; v < 8; ++v) {
                     ...
                     if (bl2 && (v < 4 || lv3.nextInt(2) != 0)) {
                        BlockState lv9 = lv2.getBlockState(lv.add(t, v, u));
                        if (lv9.isSolid() && !lv9.isIn(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE)) {
         ...
         if (lv5.getFluidState().isIn(FluidTags.WATER)) {
            for(t = 0; t < 16; ++t) {
               for(u = 0; u < 16; ++u) {
                  ...
                  if (((Biome)lv2.getBiome(lv11).value()).canSetIce(lv2, lv11, false) && this.canReplace(lv2.getBlockState(lv11))) {
