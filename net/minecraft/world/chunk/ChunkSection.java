...
public class ChunkSection {
   ...
   public void populateBiomes(BiomeSupplier biomeSupplier, MultiNoiseUtil.MultiNoiseSampler sampler, int x, int j, int k) {
      PalettedContainer lv = this.biomeContainer.slice();
      int l = true;
      ...
      for(int m = 0; m < 4; ++m) {
         for(int n = 0; n < 4; ++n) {
            for(int o = 0; o < 4; ++o) {
               lv.swapUnsafe(m, n, o, biomeSupplier.getBiome(x + m, j + n, k + o, sampler));
            }
         }
      }
