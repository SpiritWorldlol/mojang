...
public class TeleportCommand {
   ...
   private static int execute(ServerCommandSource source, Collection targets, Entity destination) throws CommandSyntaxException {
      ...
      while(var3.hasNext()) {
         ...
         teleport(source, lv, (ServerWorld)destination.getWorld(), destination.getX(), destination.getY(), destination.getZ(), EnumSet.noneOf(PositionFlag.class), destination.getYaw(), destination.getPitch(), (LookTarget)null);
      }
