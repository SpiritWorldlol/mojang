               ...
               if (lv11 != null && (!skipOldChunks || !lv11.usesOldNoise())) {
                  ...
                  for(int v = lv10.z - u; v <= lv10.z + u; ++v) {
                     for(int w = lv10.x - u; w <= lv10.x + u; ++w) {
                        ...
                        Object lv13;
                        if (lv12 instanceof WrapperProtoChunk) {
                           lv13 = new WrapperProtoChunk(((WrapperProtoChunk)lv12).getWrappedChunk(), true);
                        } else if (lv12 instanceof WorldChunk) {
                           lv13 = new WrapperProtoChunk((WorldChunk)lv12, true);
                        } else {
                           lv13 = lv12;
                        }
