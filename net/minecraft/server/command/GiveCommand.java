            ...
            while(true) {
               while(true) {
                  ...
                  if (bl && lv2.isEmpty()) {
                     ...
                     lv.getWorld().playSound((PlayerEntity)null, lv.getX(), lv.getY(), lv.getZ(), SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.PLAYERS, 0.2F, ((lv.getRandom().nextFloat() - lv.getRandom().nextFloat()) * 0.7F + 1.0F) * 2.0F);
