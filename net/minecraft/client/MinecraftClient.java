...
public class MinecraftClient extends ReentrantThreadExecutor implements WindowEventHandler {
   ...
   private void drawProfilerResults(DrawContext context, ProfileResult profileResult) {
      ...
      for(int r = 0; r < list.size(); ++r) {
         ...
         context.drawTextWithShadow(this.textRenderer, string3, j - 160, k + 80 + r * 8 + 20, lv6.getColor());
         var10000 = decimalFormat.format(lv6.parentSectionUsagePercentage);
         string3 = var10000 + "%";
         context.drawTextWithShadow(this.textRenderer, string3, j + 160 - 50 - this.textRenderer.getWidth(string3), k + 80 + r * 8 + 20, lv6.getColor());
         var10000 = decimalFormat.format(lv6.totalUsagePercentage);
         string3 = var10000 + "%";
         context.drawTextWithShadow(this.textRenderer, string3, j + 160 - this.textRenderer.getWidth(string3), k + 80 + r * 8 + 20, lv6.getColor());
      }
   ...
   public MusicSound getMusicType() {
      ...
      if (lv != null) {
         ...
         if (this.player.getWorld().getRegistryKey() == World.END) {
            ...
            RegistryEntry lv2 = this.player.getWorld().getBiome(this.player.getBlockPos());
            if (this.musicTracker.isPlayingType(MusicType.UNDERWATER) || this.player.isSubmergedInWater() && lv2.isIn(BiomeTags.PLAYS_UNDERWATER_MUSIC)) {
               ...
               return this.player.getWorld().getRegistryKey() != World.NETHER && this.player.getAbilities().creativeMode && this.player.getAbilities().allowFlying ? MusicType.CREATIVE : (MusicSound)((Biome)lv2.value()).getMusic().orElse(MusicType.GAME);
            }
         }
      } else {
