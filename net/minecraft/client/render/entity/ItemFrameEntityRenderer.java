   ...
   public void render(ItemFrameEntity arg, float f, float g, MatrixStack arg2, VertexConsumerProvider arg3, int i) {
      ...
      if (!lv3.isEmpty()) {
         ...
         if (optionalInt.isPresent()) {
            ...
            MapState lv6 = FilledMapItem.getMapState(optionalInt.getAsInt(), arg.getWorld());
            ...
            this.itemRenderer.renderItem(lv3, ModelTransformationMode.FIXED, l, OverlayTexture.DEFAULT_UV, arg2, arg3, arg.getWorld(), arg.getId());
         }
      }
