...
public class DecoratedPotBlockEntityRenderer implements BlockEntityRenderer {
   ...
   private static SpriteIdentifier getTextureIdFromSherd(Item item) {
      SpriteIdentifier lv = TexturedRenderLayers.getDecoratedPotPatternTextureId(DecoratedPotPatterns.fromSherd(item));
      if (lv == null) {
         lv = TexturedRenderLayers.getDecoratedPotPatternTextureId(DecoratedPotPatterns.fromSherd(Items.BRICK));
      }
   ...
   public void render(DecoratedPotBlockEntity arg, float f, MatrixStack arg2, VertexConsumerProvider arg3, int i, int j) {
      ...
      DecoratedPotBlockEntity.Sherds lv3 = arg.getSherds();
      this.renderDecoratedSide(this.front, arg2, arg3, i, j, getTextureIdFromSherd(lv3.front()));
      this.renderDecoratedSide(this.back, arg2, arg3, i, j, getTextureIdFromSherd(lv3.back()));
      this.renderDecoratedSide(this.left, arg2, arg3, i, j, getTextureIdFromSherd(lv3.left()));
      this.renderDecoratedSide(this.right, arg2, arg3, i, j, getTextureIdFromSherd(lv3.right()));
      arg2.pop();
   }
