...
public class RealmsGenericErrorScreen extends RealmsScreen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)((Text)this.errorMessages.getFirst()), this.width / 2, 80, 16777215);
      MultilineText var10000 = this.description;
      int var10002 = this.width / 2;
      Objects.requireNonNull(this.client.textRenderer);
      var10000.drawCenterWithShadow(context, var10002, 100, 9, 16711680);
