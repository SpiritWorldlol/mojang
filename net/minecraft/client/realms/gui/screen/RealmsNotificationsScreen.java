...
public class RealmsNotificationsScreen extends RealmsScreen {
   ...
   private void drawIcons(DrawContext context, int mouseX, int mouseY) {
      ...
      if (hasUnseenNotification) {
         context.drawTexture(UNSEEN_NOTIFICATION, n - p + 5, o + 3, 0.0F, 0.0F, 10, 10, 10, 10);
         p += 14;
      }
      ...
      if (this.currentRunnersFactory != null && this.currentRunnersFactory.isNews()) {
         if (hasUnreadNews) {
            ...
            context.drawTexture(NEWS_NOTIFICATION, (int)((double)(n + 2 - p) * 2.5), (int)((double)o * 2.5), 0.0F, 0.0F, 40, 40, 40, 40);
            context.getMatrices().pop();
            p += 14;
         }

         if (k != 0) {
            context.drawTexture(INVITE_ICON, n - p, o - 6, 0.0F, 0.0F, 15, 25, 31, 25);
            p += 16;
         }
         ...
         if (trialAvailable) {
            ...
            context.drawTexture(TRIAL_ICON, n + 4 - p, o + 4, 0.0F, (float)q, 8, 8, 8, 16);
         }
      }
