...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (this.statusTexts != null) {
         for(int k = 0; k < this.statusTexts.length; ++k) {
            context.drawCenteredTextWithShadow(this.textRenderer, this.statusTexts[k], this.width / 2, 110 + 12 * k, 16711680);
         }
      }
   ...
   private void drawDots(DrawContext context) {
      ...
      context.drawText(this.textRenderer, (String)DOTS[this.animTick / 10 % DOTS.length], this.width / 2 + i / 2 + 5, 50, 16777215, false);
   }
