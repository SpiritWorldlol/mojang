...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawText(this.textRenderer, (Text)BACKUPS_TEXT, (this.width - 150) / 2 - 90, 20, 10526880, false);
      if (this.noBackups) {
         context.drawText(this.textRenderer, (Text)NO_BACKUPS_TEXT, 20, this.height / 2 - 10, 16777215, false);
      }
   ...
   private class BackupObjectSelectionListEntry extends AlwaysSelectedEntryListWidget.Entry {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         context.drawText(RealmsBackupScreen.this.textRenderer, "Backup (" + RealmsUtil.convertToAgePresentation(this.mBackup.lastModifiedDate) + ")", x, y + 1, p, false);
