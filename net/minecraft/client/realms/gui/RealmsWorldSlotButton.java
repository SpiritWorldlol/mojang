...
public class RealmsWorldSlotButton extends ButtonWidget {
   ...
   private void drawSlotFrame(DrawContext context, int x, int y, int mouseX, int mouseY, boolean active, String slotName, int slotIndex, long imageId, @Nullable String image, boolean empty, boolean minigame, Action action, @Nullable Text actionPrompt) {
      ...
      Identifier lv2;
      if (minigame) {
         lv2 = RealmsTextureManager.getTextureId(String.valueOf(imageId), image);
      } else if (empty) {
         lv2 = EMPTY_FRAME;
      ...
      context.drawTexture(lv2, x + 3, y + 3, 0.0F, 0.0F, 74, 74, 74, 74);
      ...
      context.drawCenteredTextWithShadow(lv.textRenderer, slotName, x + 40, y + 66, 16777215);
   }
