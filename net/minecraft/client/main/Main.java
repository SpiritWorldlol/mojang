...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      TimeRecorder.INSTANCE.start(TelemetryEventProperty.LOAD_TIME_TOTAL_TIME_MS, stopwatch);
      TimeRecorder.INSTANCE.start(TelemetryEventProperty.LOAD_TIME_PRE_WINDOW_MS, stopwatch2);
      ...
      TimeRecorder.INSTANCE.setBootstrapLoadTime(Bootstrap.LOAD_TIME.get());
      ...
      try {
         ...
         CrashReport lv6 = CrashReport.create(var82, "Initializing game");
