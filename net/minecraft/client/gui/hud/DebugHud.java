...
public class DebugHud {
   ...
   private void drawMetricsData(DrawContext context, MetricsData metricsData, int x, int width, boolean showFps) {
      ...
      int var10004 = t - 60;
      Objects.requireNonNull(this.textRenderer);
      context.drawTextWithShadow(var10001, string, var10003, var10004 - 9, 14737632);
      var10001 = this.textRenderer;
      var10003 = x + p / 2;
      var10004 = t - 60;
      Objects.requireNonNull(this.textRenderer);
      context.drawCenteredTextWithShadow(var10001, string2, var10003, var10004 - 9, 14737632);
      var10001 = this.textRenderer;
      var10003 = x + p - this.textRenderer.getWidth(string3);
      var10004 = t - 60;
      Objects.requireNonNull(this.textRenderer);
      context.drawTextWithShadow(var10001, string3, var10003, var10004 - 9, 14737632);
   }
