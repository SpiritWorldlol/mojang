      ...
      if (!this.isChatHidden()) {
         ...
         if (m > 0) {
               ...
               if (lv != null) {
                  ...
                  if (w < 200 || bl) {
                     ...
                     if (x > 3) {
                        ...
                        context.getMatrices().translate(0.0F, 0.0F, 50.0F);
                        context.drawTextWithShadow(this.client.textRenderer, (OrderedText)lv.content(), 0, ab, 16777215 + (x << 24));
            ...
            if (af > 0L) {
               ...
               w = (int)(255.0 * e);
               context.getMatrices().push();
               context.getMatrices().translate(0.0F, (float)p, 50.0F);
               context.fill(-2, 0, n + 4, 9, w << 24);
               context.getMatrices().translate(0.0F, 0.0F, 50.0F);
               context.drawTextWithShadow(this.client.textRenderer, (Text)Text.translatable("chat.queue", af), 0, 1, 16777215 + (ag << 24));
               context.getMatrices().pop();
            }
            ...
            if (bl) {
               ...
               if (w != ah) {
                  ...
                  aa = n + 4;
                  context.fill(aa, -ai, aa + 2, -ai - x, z + (y << 24));
                  context.fill(aa + 2, -ai, aa + 1, -ai - x, 13421772 + (y << 24));
               }
            }
