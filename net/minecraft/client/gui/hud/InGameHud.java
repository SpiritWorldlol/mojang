...
public class InGameHud {
   ...
   public void render(DrawContext context, float tickDelta) {
      ...
      if (!this.client.options.hudHidden) {
         ...
         if (lv4 != null) {
            this.renderMountJumpBar(lv4, context, i);
      ...
      if (!this.client.options.hudHidden) {
         ...
         if (this.overlayMessage != null && this.overlayRemaining > 0) {
            ...
            if (m > 8) {
               ...
               this.drawTextBackground(context, lv2, -4, o, 16777215 | n);
               context.drawTextWithShadow(lv2, (Text)this.overlayMessage, -o / 2, -4, l | n);
         ...
         if (this.title != null && this.titleRemainTicks > 0) {
            ...
            if (m > 8) {
               ...
               this.drawTextBackground(context, lv2, -10, n, 16777215 | l);
               context.drawTextWithShadow(lv2, (Text)this.title, -n / 2, -10, 16777215 | l);
               context.getMatrices().pop();
               if (this.subtitle != null) {
                  context.getMatrices().push();
                  context.getMatrices().scale(2.0F, 2.0F, 2.0F);
                  o = lv2.getWidth((StringVisitable)this.subtitle);
                  this.drawTextBackground(context, lv2, 5, o, 16777215 | l);
                  context.drawTextWithShadow(lv2, (Text)this.subtitle, -o / 2, 5, 16777215 | l);
                  context.getMatrices().pop();
               }
         ...
         if (lv8 != null) {
            this.renderScoreboardSidebar(context, lv8);
         }
         ...
         this.chatHud.render(context, this.ticks, o, q);
         this.client.getProfiler().pop();
         ...
         if (!this.client.options.playerListKey.isPressed() || this.client.isInSingleplayer() && this.client.player.networkHandler.getListedPlayerListEntries().size() <= 1 && lv8 == null) {
            ...
            this.playerListHud.render(context, this.scaledWidth, lv5, lv8);
         }
   ...
   private void drawTextBackground(DrawContext context, TextRenderer textRenderer, int yOffset, int width, int color) {
      ...
      if (l != 0) {
         ...
         context.fill(var10001, var10002, var10003, yOffset + 9 + 2, ColorHelper.Argb.mixColor(l, color));
      }
      ...
      if (lv.getPerspective().isFirstPerson()) {
         if (this.client.interactionManager.getCurrentGameMode() != GameMode.SPECTATOR || this.shouldRenderSpectatorCrosshair(this.client.crosshairTarget)) {
            if (lv.debugEnabled && !lv.hudHidden && !this.client.player.hasReducedDebugInfo() && !(Boolean)lv.getReducedDebugInfo().getValue()) {
               ...
               lv3.push();
               lv3.multiplyPositionMatrix(context.getMatrices().peek().getPositionMatrix());
      ...
      while(var7.hasNext()) {
         ...
         if (lv3.shouldShowIcon()) {
            ...
            list.add(() -> {
               ...
               context.drawSprite(k + 3, l + 3, 0, 18, 18, lv5);
   ...
   private void renderHotbar(float tickDelta, DrawContext context) {
      ...
      if (lv != null) {
         ...
         context.drawTexture(WIDGETS_TEXTURE, i - 91 - 1 + lv.getInventory().selectedSlot * 20, this.scaledHeight - 22 - 1, 0, 22, 24, 22);
         if (!lv2.isEmpty()) {
            if (lv3 == Arm.LEFT) {
         ...
         for(m = 0; m < 9; ++m) {
            ...
            this.renderHotbarItem(context, n, o, tickDelta, lv, (ItemStack)lv.getInventory().main.get(m), l++);
         }

         if (!lv2.isEmpty()) {
            m = this.scaledHeight - 16 - 3;
            if (lv3 == Arm.LEFT) {
               this.renderHotbarItem(context, i - 91 - 26, m, tickDelta, lv, lv2, l++);
            } else {
               this.renderHotbarItem(context, i + 91 + 10, m, tickDelta, lv, lv2, l++);
            }
         }
   ...
   public void renderMountJumpBar(JumpingMount mount, DrawContext context, int x) {
      ...
      context.drawTexture(ICONS, x, l, 0, 84, 182, 5);
      if (mount.getJumpCooldown() > 0) {
         context.drawTexture(ICONS, x, l, 0, 74, 182, 5);
      } else if (k > 0) {
         context.drawTexture(ICONS, x, l, 0, 89, k, 5);
      }
   ...
   public void renderExperienceBar(DrawContext context, int x) {
      ...
      if (j > 0) {
         ...
         context.drawTexture(ICONS, x, m, 0, 64, 182, 5);
         if (l > 0) {
            context.drawTexture(ICONS, x, m, 0, 69, l, 5);
         }
      }
      ...
      if (this.client.player.experienceLevel > 0) {
         ...
         context.drawText(this.getTextRenderer(), (String)string, l + 1, m, 0, false);
         context.drawText(this.getTextRenderer(), (String)string, l - 1, m, 0, false);
         context.drawText(this.getTextRenderer(), (String)string, l, m + 1, 0, false);
         context.drawText(this.getTextRenderer(), (String)string, l, m - 1, 0, false);
         context.drawText(this.getTextRenderer(), string, l, m, 8453920, false);
         this.client.getProfiler().pop();
      }
   ...
   public void renderHeldItemTooltip(DrawContext context) {
      ...
      if (this.heldItemTooltipFade > 0 && !this.currentStack.isEmpty()) {
         ...
         if (l > 0) {
            ...
            context.drawTextWithShadow(this.getTextRenderer(), (Text)lv, j, k, 16777215 + (l << 24));
         }
      }
   ...
   public void renderDemoTimer(DrawContext context) {
      ...
      int i = this.getTextRenderer().getWidth((StringVisitable)lv);
      context.drawTextWithShadow(this.getTextRenderer(), (Text)lv, this.scaledWidth - i - 10, 5, 16777215);
      this.client.getProfiler().pop();
   }
   ...
   private void renderScoreboardSidebar(DrawContext context, ScoreboardObjective objective) {
      ...
      while(var18.hasNext()) {
         ...
         context.drawText(this.getTextRenderer(), (Text)lv7, o, t, -1, false);
         context.drawText(this.getTextRenderer(), (String)string, u - this.getTextRenderer().getWidth(string), t, -1, false);
         if (p == ((Collection)collection).size()) {
            var10001 = o - 2;
            Objects.requireNonNull(this.getTextRenderer());
            context.fill(var10001, t - 9 - 1, u, t - 1, r);
            context.fill(o - 2, t - 1, u, t, q);
            TextRenderer var32 = this.getTextRenderer();
            int var10003 = o + j / 2 - i / 2;
            Objects.requireNonNull(this.getTextRenderer());
            context.drawText(var32, (Text)lv2, var10003, t - 9, -1, false);
         }
      }
   ...
   private void renderStatusBars(DrawContext context) {
      ...
      if (lv != null) {
         ...
         this.renderHealthBar(context, lv, m, o, r, v, f, i, j, p, bl);
   ...
   private void renderHealthBar(DrawContext context, PlayerEntity player, int x, int y, int lines, int regeneratingHeartIndex, float maxHealth, int lastHealth, int health, int absorption, boolean blinking) {
      ...
      int p = 9 * (player.getWorld().getLevelProperties().isHardcore() ? 5 : 0);
      ...
      for(int t = q + r - 1; t >= 0; --t) {
         ...
         this.drawHeart(context, InGameHud.HeartType.CONTAINER, w, x, p, blinking, false);
         int y = t * 2;
         boolean bl2 = t >= q;
         if (bl2) {
            int z = y - s;
            if (z < absorption) {
               ...
               this.drawHeart(context, lv == InGameHud.HeartType.WITHERED ? lv : InGameHud.HeartType.ABSORBING, w, x, p, false, bl3);
            }
         }
         ...
         if (blinking && y < health) {
            bl4 = y + 1 == health;
            this.drawHeart(context, lv, w, x, p, true, bl4);
         }

         if (y < lastHealth) {
            bl4 = y + 1 == lastHealth;
            this.drawHeart(context, lv, w, x, p, false, bl4);
         }
      }
   ...
   private void renderPortalOverlay(DrawContext context, float nauseaStrength) {
      ...
      context.drawSprite(0, 0, -90, this.scaledWidth, this.scaledHeight, lv);
      RenderSystem.depthMask(true);
      RenderSystem.enableDepthTest();
      context.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
   }
   ...
   private void renderAutosaveIndicator(DrawContext context) {
      if ((Boolean)this.client.options.getShowAutosaveIndicator().getValue() && (this.autosaveIndicatorAlpha > 0.0F || this.lastAutosaveIndicatorAlpha > 0.0F)) {
         ...
         if (i > 8) {
            ...
            context.drawTextWithShadow(lv, SAVING_LEVEL_TEXT, this.scaledWidth - j - 10, this.scaledHeight - 15, k);
         }
      }
