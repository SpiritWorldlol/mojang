...
public class TextFieldWidget extends ClickableWidget implements Drawable {
   ...
   public void renderButton(DrawContext context, int mouseX, int mouseY, float delta) {
      if (this.isVisible()) {
         ...
         if (this.drawsBackground()) {
            ...
            context.fill(this.getX() - 1, this.getY() - 1, this.getX() + this.width + 1, this.getY() + this.height + 1, k);
         ...
         if (!string.isEmpty()) {
            ...
            p = context.drawTextWithShadow(this.textRenderer, (OrderedText)this.renderTextProvider.apply(string2, this.firstCharacterIndex), n, o, k);
         }
         ...
         if (!string.isEmpty() && bl && l < string.length()) {
            context.drawTextWithShadow(this.textRenderer, (OrderedText)this.renderTextProvider.apply(string.substring(l), this.selectionStart), p, o, k);
         }

         if (this.placeholder != null && string.isEmpty() && !this.isFocused()) {
            context.drawTextWithShadow(this.textRenderer, this.placeholder, p, o, k);
         }

         if (!bl3 && this.suggestion != null) {
            context.drawTextWithShadow(this.textRenderer, this.suggestion, q - 1, o, -8355712);
         }
         ...
         if (bl2) {
            if (bl3) {
               ...
               context.fill(q, var10002, var10003, var10004 + 9, -3092272);
            } else {
               context.drawTextWithShadow(this.textRenderer, "_", q, o, k);
            }
         }
         ...
         if (m != l) {
            ...
            int var10005 = o + 1;
            Objects.requireNonNull(this.textRenderer);
            this.drawSelectionHighlight(context, q, var10003, var10004, var10005 + 9);
         }
   ...
   private void drawSelectionHighlight(DrawContext context, int x1, int y1, int x2, int y2) {
      ...
      context.method_51739(RenderLayer.method_51786(), x1, y1, x2, y2, -16776961);
   }
