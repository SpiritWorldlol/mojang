...
public abstract class EntryListWidget extends AbstractParentElement implements Drawable, Selectable {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (o > 0) {
         ...
         context.fill(k, this.top, l, this.bottom, -16777216);
         context.fill(k, q, l, q + p, -8355712);
         context.fill(k, q, l - 1, q + p - 1, -4144960);
      }
   ...
   protected void renderEntry(DrawContext context, int mouseX, int mouseY, float delta, int index, int x, int y, int entryWidth, int entryHeight) {
      ...
      lv.drawBorder(context, index, y, x, entryWidth, entryHeight, mouseX, mouseY, Objects.equals(this.hoveredEntry, lv), delta);
      ...
      lv.render(context, index, y, x, entryWidth, entryHeight, mouseX, mouseY, Objects.equals(this.hoveredEntry, lv), delta);
   }
