...
public class AddServerScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawTextWithShadow(this.textRenderer, (Text)ENTER_NAME_TEXT, this.width / 2 - 100, 53, 10526880);
      context.drawTextWithShadow(this.textRenderer, (Text)ENTER_IP_TEXT, this.width / 2 - 100, 94, 10526880);
