...
public class SplashTextRenderer {
   ...
   public void render(DrawContext arg, int i, TextRenderer textRenderer, int j) {
      arg.getMatrices().push();
      arg.getMatrices().translate((float)i / 2.0F + 123.0F, 69.0F, 0.0F);
      arg.getMatrices().multiply(RotationAxis.POSITIVE_Z.rotationDegrees(-20.0F));
      ...
      arg.getMatrices().scale(f, f, f);
      arg.drawCenteredTextWithShadow(textRenderer, (String)this.text, 0, -8, 16776960 | j);
      arg.getMatrices().pop();
   }
}
