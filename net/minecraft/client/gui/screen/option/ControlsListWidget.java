...
public class ControlsListWidget extends ElementListWidget {
   ...
   public class CategoryEntry extends Entry {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         int var10003 = ControlsListWidget.this.client.currentScreen.width / 2 - this.textWidth / 2;
         int var10004 = y + entryHeight;
         Objects.requireNonNull(ControlsListWidget.this.client.textRenderer);
         context.drawText(var10001, var10002, var10003, var10004 - 9 - 1, 16777215, false);
      }
   ...
   public class KeyBindingEntry extends Entry {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         Objects.requireNonNull(ControlsListWidget.this.client.textRenderer);
         context.drawText(var10001, var10002, var10003, var10004 - 9 / 2, 16777215, false);
         ...
         if (this.duplicate) {
            ...
            context.fill(q, y + 2, q + 3, y + entryHeight + 2, Formatting.RED.getColorValue() | -16777216);
         }
