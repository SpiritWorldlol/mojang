...
public class OpenToLanScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)OTHER_PLAYERS_TEXT, this.width / 2, 82, 16777215);
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)PORT_TEXT, this.width / 2, 142, 16777215);
