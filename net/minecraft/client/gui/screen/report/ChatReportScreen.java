...
public class ChatReportScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)this.title, k, 10, 16777215);
      TextRenderer var10001 = this.textRenderer;
      Text var10002 = OBSERVED_WHAT_TEXT;
      int var10004 = this.getSelectionButtonY();
      Objects.requireNonNull(this.textRenderer);
      context.drawCenteredTextWithShadow(var10001, var10002, k, var10004 - 9 - 6, 16777215);
      int var10003;
      if (this.reasonDescription != null) {
         ...
         Objects.requireNonNull(this.textRenderer);
         var10000.drawWithShadow(context, var6, var10003, 9, 16777215);
      }
      ...
      Objects.requireNonNull(this.textRenderer);
      context.drawTextWithShadow(var10001, var10002, var10003, var10004 - 9 - 6, 16777215);
   ...
   class DiscardWarningScreen extends WarningScreen {
      ...
      protected void drawTitle(DrawContext context) {
         context.drawTextWithShadow(this.textRenderer, (Text)this.title, this.width / 2 - 155, 30, 16777215);
      }
