...
public class ChatSelectionScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)this.title, this.width / 2, 16, 16777215);
      ...
      Objects.requireNonNull(this.textRenderer);
      context.drawCenteredTextWithShadow(var10001, (Text)lv, var10003, 16 + 9 * 3 / 2, 10526880);
   ...
   public class SelectionListWidget extends AlwaysSelectedEntryListWidget implements MessagesListAdder.MessagesList {
      ...
      public class MessageEntry extends Entry {
         ...
         private void drawCheckmark(DrawContext context, int y, int x, int entryHeight) {
            ...
            context.drawTexture(CHECKMARK, x, m, 0.0F, 0.0F, 9, 8, 9, 8);
      ...
      public class SenderEntry extends Entry {
         ...
         public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            PlayerSkinDrawer.draw(context, this.skinTextureId, p, q, 12);
            int var10000 = y + 1;
            Objects.requireNonNull(ChatSelectionScreen.this.textRenderer);
            int r = var10000 + (entryHeight - 9) / 2;
            context.drawTextWithShadow(ChatSelectionScreen.this.textRenderer, this.headingText, x, r, this.fromReportedPlayer ? -1 : -1593835521);
         }
      }
      ...
      public class TextEntry extends Entry {
         ...
         public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            Objects.requireNonNull(ChatSelectionScreen.this.textRenderer);
            int t = p - 9 / 2;
            context.drawTextWithShadow(ChatSelectionScreen.this.textRenderer, this.text, s, t, -6250336);
         }
