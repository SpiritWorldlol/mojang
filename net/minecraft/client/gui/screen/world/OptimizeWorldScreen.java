...
public class OptimizeWorldScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawCenteredTextWithShadow(var10001, var10002, var10003, m - 9 - 2, 10526880);
      if (this.updater.getTotalChunkCount() > 0) {
         context.fill(k - 1, m - 1, l + 1, n + 1, -16777216);
         context.drawTextWithShadow(this.textRenderer, (Text)Text.translatable("optimizeWorld.info.converted", this.updater.getUpgradedChunkCount()), k, 40, 10526880);
         ...
         Objects.requireNonNull(this.textRenderer);
         context.drawTextWithShadow(var10001, (Text)var14, k, 40 + 9 + 3, 10526880);
         var10001 = this.textRenderer;
         var14 = Text.translatable("optimizeWorld.info.total", this.updater.getTotalChunkCount());
         Objects.requireNonNull(this.textRenderer);
         context.drawTextWithShadow(var10001, (Text)var14, k, 40 + (9 + 3) * 2, 10526880);
         int o = 0;
         ...
         for(Iterator var10 = this.updater.getWorlds().iterator(); var10.hasNext(); o += p) {
            ...
            context.fill(k + o, m, k + o + p, n, DIMENSION_COLORS.getInt(lv));
         }
         ...
         Objects.requireNonNull(this.textRenderer);
         context.drawCenteredTextWithShadow(var10001, var15, var10003, m + 2 * 9 + 2, 10526880);
         var10001 = this.textRenderer;
         var15 = MathHelper.floor(this.updater.getProgress() * 100.0F) + "%";
         var10003 = this.width / 2;
         int var10004 = m + (n - m) / 2;
         Objects.requireNonNull(this.textRenderer);
         context.drawCenteredTextWithShadow(var10001, var15, var10003, var10004 - 9 / 2, 10526880);
      }
