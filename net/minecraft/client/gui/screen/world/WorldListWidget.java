...
public class WorldListWidget extends AlwaysSelectedEntryListWidget {
   ...
   public static class LoadingEntry extends Entry {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         context.drawText(this.client.textRenderer, LOADING_LIST_TEXT, p, q, 16777215, false);
         String string = LoadingDisplay.get(Util.getMeasuringTimeMs());
         int r = (this.client.currentScreen.width - this.client.textRenderer.getWidth(string)) / 2;
         Objects.requireNonNull(this.client.textRenderer);
         int s = q + 9;
         context.drawText(this.client.textRenderer, string, r, s, 8421504, false);
      }
   ...
   public final class WorldEntry extends Entry implements AutoCloseable {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         int var10003 = x + 32 + 3;
         Objects.requireNonNull(this.client.textRenderer);
         context.drawText(var10001, string2, var10003, y + 9 + 3, 8421504, false);
         var10001 = this.client.textRenderer;
         var10003 = x + 32 + 3;
         Objects.requireNonNull(this.client.textRenderer);
         int var10004 = y + 9;
         Objects.requireNonNull(this.client.textRenderer);
         context.drawText(var10001, lv, var10003, var10004 + 9 + 3, 8421504, false);
         Identifier lv2 = this.icon != null ? this.iconLocation : WorldListWidget.UNKNOWN_SERVER_LOCATION;
         RenderSystem.enableBlend();
         context.drawTexture(lv2, x, y, 0.0F, 0.0F, 32, 32, 32, 32);
         ...
         if ((Boolean)this.client.options.getTouchscreen().getValue() || hovered) {
            ...
            int q = bl2 ? 32 : 0;
            if (this.level.isLocked()) {
               context.drawTexture(WorldListWidget.WORLD_SELECTION_LOCATION, x, y, 96.0F, (float)q, 32, 32, 256, 256);
               if (bl2) {
               ...
               context.drawTexture(WorldListWidget.WORLD_SELECTION_LOCATION, x, y, 32.0F, (float)q, 32, 32, 256, 256);
               if (this.level.isFutureLevel()) {
                  ...
                  context.drawTexture(WorldListWidget.WORLD_SELECTION_LOCATION, x, y, 64.0F, (float)q, 32, 32, 256, 256);
                  if (bl2) {
               ...
               context.drawTexture(WorldListWidget.WORLD_SELECTION_LOCATION, x, y, 0.0F, (float)q, 32, 32, 256, 256);
            }
         }
