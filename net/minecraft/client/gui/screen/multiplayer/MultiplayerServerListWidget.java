...
public class MultiplayerServerListWidget extends AlwaysSelectedEntryListWidget {
   ...
   public static class ScanningEntry extends Entry {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         int p = var10000 - 9 / 2;
         context.drawText(this.client.textRenderer, MultiplayerServerListWidget.LAN_SCANNING_TEXT, this.client.currentScreen.width / 2 - this.client.textRenderer.getWidth((StringVisitable)MultiplayerServerListWidget.LAN_SCANNING_TEXT) / 2, p, 16777215, false);
         ...
         Objects.requireNonNull(this.client.textRenderer);
         context.drawText(var10001, string, var10003, p + 9, 8421504, false);
      }
   ...
   public class ServerEntry extends Entry {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         for(int p = 0; p < Math.min(list.size(), 2); ++p) {
            ...
            int var10004 = y + 12;
            Objects.requireNonNull(this.client.textRenderer);
            context.drawText(var10001, var10002, var10003, var10004 + 9 * p, 8421504, false);
         }
         ...
         context.drawText(this.client.textRenderer, (Text)lv, x + entryWidth - q - 15 - 2, y + 1, 8421504, false);
         int r = 0;
         int s;
         List list2;
         Object lv2;
         ...
         context.drawTexture(MultiplayerServerListWidget.ICONS_TEXTURE, x + entryWidth - 15, y, (float)(r * 10), (float)(176 + s * 8), 10, 8, 256, 256);
