...
public class PackListWidget extends AlwaysSelectedEntryListWidget {
   ...
   protected void renderHeader(DrawContext context, int x, int y) {
      ...
      context.drawText(this.client.textRenderer, (Text)lv, x + this.width / 2 - this.client.textRenderer.getWidth((StringVisitable)lv) / 2, Math.min(this.top + 3, y), 16777215, false);
   }
   ...
   public static class ResourcePackEntry extends AlwaysSelectedEntryListWidget.Entry {
      ...
      public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         context.drawTextWithShadow(this.client.textRenderer, lv2, x + 32 + 2, y + 1, 16777215);
         lv3.drawWithShadow(context, x + 32 + 2, y + 12, 10, 8421504);
      }
