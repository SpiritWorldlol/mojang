...
public class TitleScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.setShaderColor(1.0F, 1.0F, 1.0F, this.doBackgroundFade ? (float)MathHelper.ceil(MathHelper.clamp(g, 0.0F, 1.0F)) : 1.0F);
      ...
      this.logoDrawer.draw(context, this.width, h);
      ...
      if ((k & -67108864) != 0) {
         ...
         context.drawTextWithShadow(this.textRenderer, (String)string, 2, this.height - 10, 16777215 | k);
   ...
   private static record DeprecationNotice(TextRenderer textRenderer, MultilineText label, int x, int y) {
      ...
      public void render(DrawContext context, int color) {
         ...
         var10000.fillBackground(context, var10002, var10003, 9, 2, 2097152 | Math.min(color, 1426063360));
         var10000 = this.label;
         var10002 = this.x;
         var10003 = this.y;
         Objects.requireNonNull(this.textRenderer);
         var10000.drawCenterWithShadow(context, var10002, var10003, 9, 16777215 | color);
      }
