...
public class BeaconScreen extends HandledScreen {
   ...
   protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)PRIMARY_POWER_TEXT, 62, 10, 14737632);
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)SECONDARY_POWER_TEXT, 169, 10, 14737632);
   }
   ...
   private abstract static class BaseButtonWidget extends PressableWidget implements BeaconButtonWidget {
      ...
      public void renderButton(DrawContext context, int mouseX, int mouseY, float delta) {
         ...
         context.drawTexture(BeaconScreen.TEXTURE, this.getX(), this.getY(), l, 219, this.width, this.height);
