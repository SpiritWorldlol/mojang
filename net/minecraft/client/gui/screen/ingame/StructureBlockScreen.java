...
public class StructureBlockScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (lv != StructureBlockMode.DATA) {
         context.drawTextWithShadow(this.textRenderer, (Text)STRUCTURE_NAME_TEXT, this.width / 2 - 153, 30, 10526880);
         this.inputName.render(context, mouseX, mouseY, delta);
      }

      if (lv == StructureBlockMode.LOAD || lv == StructureBlockMode.SAVE) {
         context.drawTextWithShadow(this.textRenderer, (Text)POSITION_TEXT, this.width / 2 - 153, 70, 10526880);
         ...
         context.drawTextWithShadow(this.textRenderer, (Text)INCLUDE_ENTITIES_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)INCLUDE_ENTITIES_TEXT), 150, 10526880);
      }

      if (lv == StructureBlockMode.SAVE) {
         context.drawTextWithShadow(this.textRenderer, (Text)SIZE_TEXT, this.width / 2 - 153, 110, 10526880);
         ...
         context.drawTextWithShadow(this.textRenderer, (Text)DETECT_SIZE_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)DETECT_SIZE_TEXT), 110, 10526880);
         context.drawTextWithShadow(this.textRenderer, (Text)SHOW_AIR_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)SHOW_AIR_TEXT), 70, 10526880);
      }

      if (lv == StructureBlockMode.LOAD) {
         context.drawTextWithShadow(this.textRenderer, (Text)INTEGRITY_TEXT, this.width / 2 - 153, 110, 10526880);
         this.inputIntegrity.render(context, mouseX, mouseY, delta);
         this.inputSeed.render(context, mouseX, mouseY, delta);
         context.drawTextWithShadow(this.textRenderer, (Text)SHOW_BOUNDING_BOX_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)SHOW_BOUNDING_BOX_TEXT), 70, 10526880);
      }

      if (lv == StructureBlockMode.DATA) {
         context.drawTextWithShadow(this.textRenderer, (Text)CUSTOM_DATA_TEXT, this.width / 2 - 153, 110, 10526880);
         this.inputMetadata.render(context, mouseX, mouseY, delta);
      }

      context.drawTextWithShadow(this.textRenderer, (Text)lv.asText(), this.width / 2 - 153, 174, 10526880);
