...
public abstract class HandledScreen extends Screen implements ScreenHandlerProvider {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.getMatrices().translate((float)k, (float)l, 0.0F);
      ...
      for(int m = 0; m < this.handler.slots.size(); ++m) {
         ...
         if (this.isPointOverSlot(lv, (double)mouseX, (double)mouseY) && lv.isEnabled()) {
            ...
            if (this.focusedSlot.method_51306()) {
               drawSlotHighlight(context, n, o, 0);
            }
         }
      }
      ...
      if (!this.touchDropReturningStack.isEmpty()) {
         ...
         this.drawItem(context, this.touchDropReturningStack, q, r, (String)null);
      }
   ...
   private void drawSlot(DrawContext context, Slot slot) {
      ...
      if (!bl2) {
         ...
         context.drawItem(lv, i, j, slot.x + slot.y * this.backgroundWidth);
