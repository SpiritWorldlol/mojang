...
public class BookEditScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      int l = true;
      context.drawTexture(BookScreen.BOOK_TEXTURE, k, 2, 0, 0, 192, 192);
      int n;
      int o;
      if (this.signing) {
         ...
         context.drawText(this.textRenderer, (Text)EDIT_TITLE_TEXT, k + 36 + (114 - m) / 2, 34, 0, false);
         n = this.textRenderer.getWidth(lv);
         context.drawText(this.textRenderer, (OrderedText)lv, k + 36 + (114 - n) / 2, 50, 0, false);
         o = this.textRenderer.getWidth((StringVisitable)this.signedByText);
         context.drawText(this.textRenderer, (Text)this.signedByText, k + 36 + (114 - o) / 2, 60, 0, false);
         ...
         context.drawText(this.textRenderer, (Text)this.pageIndicatorText, k - p + 192 - 44, 18, 0, false);
         ...
         for(o = 0; o < n; ++o) {
            Line lv3 = var15[o];
            context.drawText(this.textRenderer, lv3.text, lv3.x, lv3.y, -16777216, false);
         }
   ...
   private void drawCursor(DrawContext context, Position position, boolean atEnd) {
      if (this.tickCounter / 6 % 2 == 0) {
         ...
         if (!atEnd) {
            ...
            context.drawText(this.textRenderer, (String)"_", position.x, position.y, 0, false);
         }
      }
