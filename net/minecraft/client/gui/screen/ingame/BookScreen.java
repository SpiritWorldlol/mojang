...
public class BookScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      int l = true;
      context.drawTexture(BOOK_TEXTURE, k, 2, 0, 0, 192, 192);
      ...
      context.drawText(this.textRenderer, (Text)this.pageIndexText, k - m + 192 - 44, 18, 0, false);
      ...
      for(int o = 0; o < n; ++o) {
         ...
         int var10003 = k + 36;
         Objects.requireNonNull(this.textRenderer);
         context.drawText(var10001, (OrderedText)lv2, var10003, 32 + o * 9, 0, false);
      }
