...
public class Items {
   ...
   public static Item register(RegistryKey key, Item item) {
   ...
   static {
      ...
      MUSIC_DISC_RELIC = register((String)"music_disc_relic", (Item)(new MusicDiscItem(14, SoundEvents.MUSIC_DISC_RELIC, (new Item.Settings()).maxCount(1).rarity(Rarity.RARE), 218)));
      ...
      ANGLER_POTTERY_SHERD = register("angler_pottery_sherd", new Item(new Item.Settings()));
      ARCHER_POTTERY_SHERD = register("archer_pottery_sherd", new Item(new Item.Settings()));
      ARMS_UP_POTTERY_SHERD = register("arms_up_pottery_sherd", new Item(new Item.Settings()));
      BLADE_POTTERY_SHERD = register("blade_pottery_sherd", new Item(new Item.Settings()));
      BREWER_POTTERY_SHERD = register("brewer_pottery_sherd", new Item(new Item.Settings()));
      BURN_POTTERY_SHERD = register("burn_pottery_sherd", new Item(new Item.Settings()));
      DANGER_POTTERY_SHERD = register("danger_pottery_sherd", new Item(new Item.Settings()));
      EXPLORER_POTTERY_SHERD = register("explorer_pottery_sherd", new Item(new Item.Settings()));
      FRIEND_POTTERY_SHERD = register("friend_pottery_sherd", new Item(new Item.Settings()));
      HEART_POTTERY_SHERD = register("heart_pottery_sherd", new Item(new Item.Settings()));
      HEARTBREAK_POTTERY_SHERD = register("heartbreak_pottery_sherd", new Item(new Item.Settings()));
      HOWL_POTTERY_SHERD = register("howl_pottery_sherd", new Item(new Item.Settings()));
      MINER_POTTERY_SHERD = register("miner_pottery_sherd", new Item(new Item.Settings()));
      MOURNER_POTTERY_SHERD = register("mourner_pottery_sherd", new Item(new Item.Settings()));
      PLENTY_POTTERY_SHERD = register("plenty_pottery_sherd", new Item(new Item.Settings()));
      PRIZE_POTTERY_SHERD = register("prize_pottery_sherd", new Item(new Item.Settings()));
      SHEAF_POTTERY_SHERD = register("sheaf_pottery_sherd", new Item(new Item.Settings()));
      SHELTER_POTTERY_SHERD = register("shelter_pottery_sherd", new Item(new Item.Settings()));
      SKULL_POTTERY_SHERD = register("skull_pottery_sherd", new Item(new Item.Settings()));
      SNORT_POTTERY_SHERD = register("snort_pottery_sherd", new Item(new Item.Settings()));
   }
}
