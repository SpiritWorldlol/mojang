...
public class TravelCriterion extends AbstractCriterion {
   ...
   public void trigger(ServerPlayerEntity player, Vec3d startPos) {
      ...
      this.trigger(player, (conditions) -> {
         return conditions.matches(player.getServerWorld(), startPos, lv);
      });
   }
   ...
   public static class Conditions extends AbstractCriterionConditions {
      ...
      public Conditions(Identifier id, EntityConditions entity, LocationPredicate startPos, DistancePredicate distance) {
         super(id, entity);
      ...
      public static Conditions fallFromHeight(EntityPredicate.Builder entity, DistancePredicate distance, LocationPredicate startPos) {
         return new Conditions(Criteria.FALL_FROM_HEIGHT.id, EntityPredicate.toConditions(entity.build()), startPos, distance);
      }

      public static Conditions rideEntityInLava(EntityPredicate.Builder entity, DistancePredicate distance) {
         return new Conditions(Criteria.RIDE_ENTITY_IN_LAVA.id, EntityPredicate.toConditions(entity.build()), LocationPredicate.ANY, distance);
      }

      public static Conditions netherTravel(DistancePredicate distance) {
         return new Conditions(Criteria.NETHER_TRAVEL.id, EntityConditions.EMPTY, LocationPredicate.ANY, distance);
      }
