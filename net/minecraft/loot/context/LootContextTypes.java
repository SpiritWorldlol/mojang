...
public class LootContextTypes {
   ...
   public static final LootContextType ADVANCEMENT_LOCATION = register("advancement_location", (arg) -> {
      arg.require(LootContextParameters.THIS_ENTITY).require(LootContextParameters.ORIGIN).require(LootContextParameters.TOOL).require(LootContextParameters.BLOCK_STATE);
   });
