...
public class CraftingResultSlot extends Slot {
   ...
   protected void onCrafted(ItemStack stack) {
      ...
      if (var3 instanceof RecipeUnlocker lv) {
         lv.unlockLastRecipe(this.player, this.input.getInputStacks());
      }
   ...
   public void onTakeItem(PlayerEntity player, ItemStack stack) {
      this.onCrafted(stack);
      DefaultedList lv = player.getWorld().getRecipeManager().getRemainingStacks(RecipeType.CRAFTING, this.input, player.getWorld());
