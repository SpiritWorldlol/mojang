...
public class Schemas {
   ...
   private static void build(DataFixerBuilder builder) {
      ...
      Set var194 = Set.of("minecraft:unemployed", "minecraft:nitwit");
      Objects.requireNonNull(var194);
      builder.addFixer(new PointOfInterestRemoveFix(schema166, "Remove unpopulated villager PoI types", var194::contains));
      ...
      builder.addFixer(ItemNameFix.create(schema184, "Pottery shard item renaming to Pottery sherd", replacing((Map)Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), (string) -> {
      ...
      builder.addFixer(new RenameChunkStatusFix(schema186, "Remove liquid_carvers and heightmap chunk statuses", replacing(Map.of("liquid_carvers", "carvers", "heightmaps", "spawn"))));
