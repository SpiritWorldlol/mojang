   ...
   public void tick() {
      if (this.block.isAir()) {
         ...
         if (!this.getWorld().isClient) {
            ...
            if (bl && d > 1.0) {
               BlockHitResult lv3 = this.getWorld().raycast(new RaycastContext(new Vec3d(this.prevX, this.prevY, this.prevZ), this.getPos(), RaycastContext.ShapeType.COLLIDER, RaycastContext.FluidHandling.SOURCE_ONLY, this));
               if (lv3.getType() != HitResult.Type.MISS && this.getWorld().getFluidState(lv3.getBlockPos()).isIn(FluidTags.WATER)) {
                  lv2 = lv3.getBlockPos();
                  bl2 = true;
               }
            }
            ...
            if (!this.isOnGround() && !bl2) {
               if (!this.getWorld().isClient && (this.timeFalling > 100 && (lv2.getY() <= this.getWorld().getBottomY() || lv2.getY() > this.getWorld().getTopY()) || this.timeFalling > 600)) {
               ...
               if (!lv4.isOf(Blocks.MOVING_PISTON)) {
                  if (!this.destroyedOnLanding) {
                     ...
                     boolean bl5 = this.block.canPlaceAt(this.getWorld(), lv2) && !bl4;
                     if (bl3 && bl5) {
                        ...
                        if (this.getWorld().setBlockState(lv2, this.block, Block.NOTIFY_ALL)) {
                           ((ServerWorld)this.getWorld()).getChunkManager().threadedAnvilChunkStorage.sendToOtherNearbyPlayers(this, new BlockUpdateS2CPacket(lv2, this.getWorld().getBlockState(lv2)));
                           this.discard();
                           if (lv instanceof LandingBlock) {
                              ((LandingBlock)lv).onLanding(this.getWorld(), lv2, this.block, lv4, this);
                           }

                           if (this.blockEntityData != null && this.block.hasBlockEntity()) {
                              BlockEntity lv5 = this.getWorld().getBlockEntity(lv2);
                              if (lv5 != null) {
