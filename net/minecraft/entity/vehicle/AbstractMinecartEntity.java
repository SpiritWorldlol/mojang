         ...
         while(var7.hasNext()) {
            ...
            while(var11.hasNext()) {
               ...
               for(int var15 = 0; var15 < var14; ++var15) {
                  ...
                  double d = this.getWorld().getDismountHeight(Dismounting.getCollisionShape(this.getWorld(), lv3), () -> {
                     return Dismounting.getCollisionShape(this.getWorld(), lv3.down());
                  });
                  if (Dismounting.canDismountInBlock(d)) {
                     Box lv6 = new Box((double)(-f), 0.0, (double)(-f), (double)f, (double)lv5.height, (double)f);
                     Vec3d lv7 = Vec3d.ofCenter(lv3, d);
                     if (Dismounting.canPlaceEntityAt(this.getWorld(), passenger, lv6.offset(lv7))) {
   ...
   public void tick() {
      ...
      if (this.getWorld().isClient) {
         ...
         if (this.getMinecartType() == AbstractMinecartEntity.Type.RIDEABLE && this.getVelocity().horizontalLengthSquared() > 0.01) {
            List list = this.getWorld().getOtherEntities(this, this.getBoundingBox().expand(0.20000000298023224, 0.0, 0.20000000298023224), EntityPredicates.canBePushedBy(this));
            if (!list.isEmpty()) {
            ...
            Iterator var12 = this.getWorld().getOtherEntities(this, this.getBoundingBox().expand(0.20000000298023224, 0.0, 0.20000000298023224)).iterator();
