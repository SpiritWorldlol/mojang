...
public class TntMinecartEntity extends AbstractMinecartEntity {
   ...
   protected void explode(@Nullable DamageSource damageSource, double power) {
      if (!this.getWorld().isClient) {
         ...
         this.getWorld().createExplosion(this, damageSource, (ExplosionBehavior)null, this.getX(), this.getY(), this.getZ(), (float)(4.0 + this.random.nextDouble() * 1.5 * e), false, World.ExplosionSourceType.TNT);
         this.discard();
      }
   ...
   public void prime() {
      ...
      if (!this.getWorld().isClient) {
         ...
         if (!this.isSilent()) {
            this.getWorld().playSound((PlayerEntity)null, this.getX(), this.getY(), this.getZ(), SoundEvents.ENTITY_TNT_PRIMED, SoundCategory.BLOCKS, 1.0F, 1.0F);
         }
      }
