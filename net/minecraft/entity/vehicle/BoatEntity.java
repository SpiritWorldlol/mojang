...
public class BoatEntity extends Entity implements VariantHolder {
         ...
         if (this.isPaddleMoving(i)) {
            if (!this.isSilent() && (double)(this.paddlePhases[i] % 6.2831855F) <= 0.7853981852531433 && (double)((this.paddlePhases[i] + 0.3926991F) % 6.2831855F) >= 0.7853981852531433) {
               ...
               if (lv != null) {
                  ...
                  this.getWorld().playSound((PlayerEntity)null, this.getX() + d, this.getY(), this.getZ() + e, lv, this.getSoundCategory(), 1.0F, 0.8F + 0.4F * this.random.nextFloat());
               }
            }
            ...
            if (r != 2) {
               for(int s = k; s < l; ++s) {
                  if (r <= 0 || s != k && s != l - 1) {
                     ...
                     if (!(lv5.getBlock() instanceof LilyPadBlock) && VoxelShapes.matchesAnywhere(lv5.getCollisionShape(this.getWorld(), lv4).offset((double)p, (double)s, (double)q), lv3, BooleanBiFunction.AND)) {
      ...
      for(int o = i; o < j; ++o) {
         for(int p = k; p < l; ++p) {
            for(int q = m; q < n; ++q) {
               lv2.set(o, p, q);
               FluidState lv3 = this.getWorld().getFluidState(lv2);
               if (lv3.isIn(FluidTags.WATER) && d < (double)((float)lv2.getY() + lv3.getHeight(this.getWorld(), lv2))) {
                  if (!lv3.isStill()) {
   ...
   public Vec3d updatePassengerForDismount(LivingEntity passenger) {
      ...
      if (!this.getWorld().isWater(lv3)) {
         ...
         double g = this.getWorld().getDismountHeight(lv3);
         ...
         while(var14.hasNext()) {
            ...
            while(var16.hasNext()) {
               ...
               if (Dismounting.canPlaceEntityAt(this.getWorld(), lv5, passenger, lv4)) {
