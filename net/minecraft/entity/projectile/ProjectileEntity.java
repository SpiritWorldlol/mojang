...
public abstract class ProjectileEntity extends Entity implements Ownable {
   ...
   private boolean shouldLeaveOwner() {
      ...
      if (lv != null) {
         Iterator var2 = this.getWorld().getOtherEntities(this, this.getBoundingBox().stretch(this.getVelocity()).expand(1.0), (entity) -> {
   ...
   protected void onCollision(HitResult hitResult) {
      ...
      if (lv == HitResult.Type.ENTITY) {
         ...
         this.getWorld().emitGameEvent(GameEvent.PROJECTILE_LAND, lv3, GameEvent.Emitter.of(this, this.getWorld().getBlockState(lv3)));
      }
