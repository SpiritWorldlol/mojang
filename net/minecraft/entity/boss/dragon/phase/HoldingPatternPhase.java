...
public class HoldingPatternPhase extends AbstractPhase {
   ...
   private void tickInRange() {
      ...
      if (this.path != null && this.path.isFinished()) {
         BlockPos lv = this.dragon.getWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, new BlockPos(EndPortalFeature.ORIGIN));
         ...
         PlayerEntity lv2 = this.dragon.getWorld().getClosestPlayer(PLAYERS_IN_RANGE_PREDICATE, this.dragon, (double)lv.getX(), (double)lv.getY(), (double)lv.getZ());
         double d;
         if (lv2 != null) {
