...
public class LandingPhase extends AbstractPhase {
   ...
   public void clientTick() {
      ...
      for(int i = 0; i < 8; ++i) {
         ...
         this.dragon.getWorld().addParticle(ParticleTypes.DRAGON_BREATH, g, h, j, -lv.x * 0.07999999821186066 + lv3.x, -lv.y * 0.30000001192092896 + lv3.y, -lv.z * 0.07999999821186066 + lv3.z);
