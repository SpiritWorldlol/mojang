...
public abstract class RaiderEntity extends PatrolEntity {
         ...
         if (this.canJoinRaid()) {
            if (lv == null) {
               if (this.getWorld().getTime() % 20L == 0L) {
                  Raid lv2 = ((ServerWorld)this.getWorld()).getRaidAt(this.getBlockPos());
   ...
   public void onDeath(DamageSource damageSource) {
      if (this.getWorld() instanceof ServerWorld) {
         ...
         if (this.isPatrolLeader() && lv2 == null && ((ServerWorld)this.getWorld()).getRaidAt(this.getBlockPos()) == null) {
   ...
   public class PickupBannerAsLeaderGoal extends Goal {
      ...
      public boolean canStart() {
         ...
         if (this.actor.hasActiveRaid() && !this.actor.getRaid().isFinished() && this.actor.canLead() && !ItemStack.areEqual(this.actor.getEquippedStack(EquipmentSlot.HEAD), Raid.getOminousBanner())) {
            ...
            if (lv2 == null || !lv2.isAlive()) {
               List list = this.actor.getWorld().getEntitiesByClass(ItemEntity.class, this.actor.getBoundingBox().expand(16.0, 8.0, 16.0), RaiderEntity.OBTAINABLE_OMINOUS_BANNER_PREDICATE);
               if (!list.isEmpty()) {
      ...
      public void tick() {
         if (this.actor.getNavigation().getTargetPos().isWithinDistance(this.actor.getPos(), 1.414)) {
            List list = this.actor.getWorld().getEntitiesByClass(ItemEntity.class, this.actor.getBoundingBox().expand(4.0, 4.0, 4.0), RaiderEntity.OBTAINABLE_OMINOUS_BANNER_PREDICATE);
            if (!list.isEmpty()) {
   ...
   protected class PatrolApproachGoal extends Goal {
      ...
      public void start() {
         ...
         List list = this.raider.getWorld().getTargets(RaiderEntity.class, this.closeRaiderPredicate, this.raider, this.raider.getBoundingBox().expand(8.0, 8.0, 8.0));
