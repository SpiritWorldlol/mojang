...
public class TadpoleEntity extends FishEntity {
   ...
   private void growUp() {
      ...
      if (var2 instanceof ServerWorld lv) {
         FrogEntity lv2 = (FrogEntity)EntityType.FROG.create(this.getWorld());
         if (lv2 != null) {
            lv2.refreshPositionAndAngles(this.getX(), this.getY(), this.getZ(), this.getYaw(), this.getPitch());
            lv2.initialize(lv, this.getWorld().getLocalDifficulty(lv2.getBlockPos()), SpawnReason.CONVERSION, (EntityData)null, (NbtCompound)null);
