...
public class PufferfishEntity extends FishEntity {
   ...
   public void tickMovement() {
      ...
      if (this.isAlive() && this.getPuffState() > 0) {
         List list = this.getWorld().getEntitiesByClass(MobEntity.class, this.getBoundingBox().expand(0.3), (entity) -> {
   ...
   private static class InflateGoal extends Goal {
      ...
      public boolean canStart() {
         List list = this.pufferfish.getWorld().getEntitiesByClass(LivingEntity.class, this.pufferfish.getBoundingBox().expand(2.0), (arg) -> {
