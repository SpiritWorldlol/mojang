...
public class SnowGolemEntity extends GolemEntity implements Shearable, RangedAttackMob {
   ...
   public void tickMovement() {
      ...
      if (!this.getWorld().isClient) {
         ...
         for(int i = 0; i < 4; ++i) {
            ...
            if (this.getWorld().getBlockState(lv2).isAir() && lv.canPlaceAt(this.getWorld(), lv2)) {
   ...
   public void sheared(SoundCategory shearedSoundCategory) {
      this.getWorld().playSoundFromEntity((PlayerEntity)null, this, SoundEvents.ENTITY_SNOW_GOLEM_SHEAR, shearedSoundCategory, 1.0F, 1.0F);
      if (!this.getWorld().isClient()) {
