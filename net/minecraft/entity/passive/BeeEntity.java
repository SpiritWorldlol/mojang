               ...
               if (lv2.isIn(BlockTags.BEE_GROWABLES)) {
                  if (lv3 instanceof CropBlock) {
                     ...
                     if (lv3 instanceof StemBlock) {
                        ...
                        ((Fertilizable)lv2.getBlock()).grow((ServerWorld)BeeEntity.this.getWorld(), BeeEntity.this.random, lv, lv2);
                     }
                  }

                  if (bl) {
                     BeeEntity.this.getWorld().syncWorldEvent(WorldEvents.PLANT_FERTILIZED, lv, 0);
                     BeeEntity.this.getWorld().setBlockState(lv, (BlockState)lv2.with(lv4, (Integer)lv2.get(lv4) + 1));
