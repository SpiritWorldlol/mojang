   ...
   public Vec3d updatePassengerForDismount(LivingEntity passenger) {
      ...
      while(true) {
         ...
         do {
            ...
            } while(this.getWorld().getFluidState(lv3).isIn(FluidTags.LAVA));

            g = this.getWorld().getDismountHeight(lv3);
         ...
         while(var14.hasNext()) {
            ...
            if (Dismounting.canPlaceEntityAt(this.getWorld(), passenger, lv6.offset(lv4))) {
   ...
   public ActionResult interactMob(PlayerEntity player, Hand hand) {
      ...
      if (!bl && this.isSaddled() && !this.hasPassengers() && !player.shouldCancelInteraction()) {
         ...
         if (!lv.isAccepted()) {
            ...
            if (bl && !this.isSilent()) {
               this.getWorld().playSound((PlayerEntity)null, this.getX(), this.getY(), this.getZ(), SoundEvents.ENTITY_STRIDER_EAT, this.getSoundCategory(), 1.0F, 1.0F + (this.random.nextFloat() - this.random.nextFloat()) * 0.2F);
            }
