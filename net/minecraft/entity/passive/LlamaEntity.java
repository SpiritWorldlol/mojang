...
public class LlamaEntity extends AbstractDonkeyEntity implements VariantHolder, RangedAttackMob {
   ...
   protected boolean receiveFood(PlayerEntity player, ItemStack item) {
      ...
      if (bl && !this.isSilent()) {
         ...
         if (lv != null) {
            this.getWorld().playSound((PlayerEntity)null, this.getX(), this.getY(), this.getZ(), this.getEatSound(), this.getSoundCategory(), 1.0F, 1.0F + (this.random.nextFloat() - this.random.nextFloat()) * 0.2F);
         }
      }
   ...
   protected LlamaEntity createChild() {
      return (LlamaEntity)EntityType.LLAMA.create(this.getWorld());
   }
