...
public class ItemFrameEntity extends AbstractDecorationEntity {
   ...
   public boolean canStayAttached() {
      if (this.fixed) {
         ...
         return lv.isSolid() || this.facing.getAxis().isHorizontal() && AbstractRedstoneGateBlock.isRedstoneGate(lv) ? this.getWorld().getOtherEntities(this, this.getBoundingBox(), PREDICATE).isEmpty() : false;
      }
   }
   ...
   private void removeFromFrame(ItemStack arg) {
      this.getMapId().ifPresent((i) -> {
         MapState lv = FilledMapItem.getMapState(i, this.getWorld());
         if (lv != null) {
