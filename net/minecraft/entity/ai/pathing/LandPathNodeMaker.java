   ...
   public PathNode getStart() {
      ...
      if (!this.entity.canWalkOnFluid(lv2.getFluidState())) {
         if (this.canSwim() && this.entity.isTouchingWater()) {
            ...
            for(lv3 = this.entity.getBlockPos(); (this.cachedWorld.getBlockState(lv3).isAir() || this.cachedWorld.getBlockState(lv3).canPathfindThrough(this.cachedWorld, lv3, NavigationType.LAND)) && lv3.getY() > this.entity.getWorld().getBottomY(); lv3 = lv3.down()) {
            }
