...
public class LookTargetUtil {
   ...
   public static Vec3d find(PathAwareEntity entity, int horizontalRange, int verticalRange) {
      ...
      for(int k = 0; lv != null && !entity.getWorld().getBlockState(BlockPos.ofFloored(lv)).canPathfindThrough(entity.getWorld(), BlockPos.ofFloored(lv), NavigationType.WATER) && k++ < 10; lv = NoPenaltyTargeting.find(entity, horizontalRange, verticalRange)) {
      }
