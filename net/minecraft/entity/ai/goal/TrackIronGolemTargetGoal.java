...
public class TrackIronGolemTargetGoal extends TrackTargetGoal {
   ...
   public boolean canStart() {
      ...
      List list = this.golem.getWorld().getTargets(VillagerEntity.class, this.targetPredicate, this.golem, lv);
      List list2 = this.golem.getWorld().getPlayers(this.targetPredicate, this.golem, lv);
