...
public class SkeletonHorseTrapTriggerGoal extends Goal {
   ...
   private AbstractHorseEntity getHorse(LocalDifficulty localDifficulty) {
      SkeletonHorseEntity lv = (SkeletonHorseEntity)EntityType.SKELETON_HORSE.create(this.skeletonHorse.getWorld());
      if (lv != null) {
         lv.initialize((ServerWorld)this.skeletonHorse.getWorld(), localDifficulty, SpawnReason.TRIGGERED, (EntityData)null, (NbtCompound)null);
   ...
   private SkeletonEntity getSkeleton(LocalDifficulty localDifficulty, AbstractHorseEntity vehicle) {
      SkeletonEntity lv = (SkeletonEntity)EntityType.SKELETON.create(vehicle.getWorld());
      if (lv != null) {
         lv.initialize((ServerWorld)vehicle.getWorld(), localDifficulty, SpawnReason.TRIGGERED, (EntityData)null, (NbtCompound)null);
