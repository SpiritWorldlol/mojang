               ...
               if (this.fireballCooldown <= 0) {
                  ...
                  if (this.fireballsFired > 1) {
                     ...
                     if (!this.blaze.isSilent()) {
                        this.blaze.getWorld().syncWorldEvent((PlayerEntity)null, WorldEvents.BLAZE_SHOOTS, this.blaze.getBlockPos(), 0);
                     }

                     for(int i = 0; i < 1; ++i) {
                        SmallFireballEntity lv2 = new SmallFireballEntity(this.blaze.getWorld(), this.blaze, this.blaze.getRandom().nextTriangular(e, 2.297 * h), f, this.blaze.getRandom().nextTriangular(g, 2.297 * h));
                        lv2.setPosition(lv2.getX(), this.blaze.getBodyY(0.5) + 0.5, lv2.getZ());
                        this.blaze.getWorld().spawnEntity(lv2);
                     }
                  }
               }
