   ...
   private class SummonVexGoal extends SpellcastingIllagerEntity.CastSpellGoal {
      ...
      protected void castSpell() {
         ...
         for(int i = 0; i < 3; ++i) {
            ...
            VexEntity lv3 = (VexEntity)EntityType.VEX.create(EvokerEntity.this.getWorld());
            if (lv3 != null) {
               lv3.refreshPositionAndAngles(lv2, 0.0F, 0.0F);
               lv3.initialize(lv, EvokerEntity.this.getWorld().getLocalDifficulty(lv2), SpawnReason.MOB_SUMMONED, (EntityData)null, (NbtCompound)null);
   ...
   private class ConjureFangsGoal extends SpellcastingIllagerEntity.CastSpellGoal {
      ...
      private void conjureFangs(double x, double z, double maxY, double y, float yaw, int warmup) {
         ...
         do {
            ...
            if (lv3.isSideSolidFullSquare(EvokerEntity.this.getWorld(), lv2, Direction.UP)) {
               if (!EvokerEntity.this.getWorld().isAir(lv)) {
                  BlockState lv4 = EvokerEntity.this.getWorld().getBlockState(lv);
                  VoxelShape lv5 = lv4.getCollisionShape(EvokerEntity.this.getWorld(), lv);
                  if (!lv5.isEmpty()) {
   ...
   public class WololoGoal extends SpellcastingIllagerEntity.CastSpellGoal {
      ...
      public boolean canStart() {
         if (EvokerEntity.this.getTarget() != null) {
            ...
            List list = EvokerEntity.this.getWorld().getTargets(SheepEntity.class, this.convertibleSheepPredicate, EvokerEntity.this, EvokerEntity.this.getBoundingBox().expand(16.0, 4.0, 16.0));
            if (list.isEmpty()) {
               return false;
            } else {
