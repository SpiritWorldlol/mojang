...
public class ZombieEntity extends HostileEntity {
   ...
   protected void convertInWater() {
      ...
      if (!this.isSilent()) {
         this.getWorld().syncWorldEvent((PlayerEntity)null, WorldEvents.ZOMBIE_CONVERTS_TO_DROWNED, this.getBlockPos(), 0);
      }
      ...
      if (!super.damage(source, amount)) {
         ...
         if (lv2 != null && this.getWorld().getDifficulty() == Difficulty.HARD && (double)this.random.nextFloat() < this.getAttributeValue(EntityAttributes.ZOMBIE_SPAWN_REINFORCEMENTS) && this.getWorld().getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING)) {
            ...
            for(int l = 0; l < 50; ++l) {
               ...
               if (SpawnHelper.canSpawn(lv6, this.getWorld(), lv4, lv5) && SpawnRestriction.canSpawn(lv5, lv, SpawnReason.REINFORCEMENT, lv4, this.getWorld().random)) {
                  lv3.setPosition((double)m, (double)n, (double)o);
                  if (!this.getWorld().isPlayerInRange((double)m, (double)n, (double)o, 7.0) && this.getWorld().doesNotIntersectEntities(lv3) && this.getWorld().isSpaceEmpty(lv3) && !this.getWorld().containsFluid(lv3.getBoundingBox())) {
                     lv3.setTarget(lv2);
                     lv3.initialize(lv, this.getWorld().getLocalDifficulty(lv3.getBlockPos()), SpawnReason.REINFORCEMENT, (EntityData)null, (NbtCompound)null);
         ...
         if (lv2.baby) {
            ...
            if (lv2.tryChickenJockey) {
               if ((double)lv.nextFloat() < 0.05) {
                  ...
                  ChickenEntity lv4 = (ChickenEntity)EntityType.CHICKEN.create(this.getWorld());
                  if (lv4 != null) {
