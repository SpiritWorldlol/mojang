...
public abstract class PatrolEntity extends HostileEntity {
   ...
   public static class PatrolGoal extends Goal {
      ...
      public void tick() {
         ...
         if (lv.isIdle()) {
            ...
            if (this.entity.isRaidCenterSet() && list.isEmpty()) {
               ...
               lv6 = this.entity.getWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, lv6);
      ...
      private List findPatrolTargets() {
         return this.entity.getWorld().getEntitiesByClass(PatrolEntity.class, this.entity.getBoundingBox().expand(16.0), (arg) -> {
      ...
      private boolean wander() {
         ...
         BlockPos lv2 = this.entity.getWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, this.entity.getBlockPos().add(-8 + lv.nextInt(16), 0, -8 + lv.nextInt(16)));
