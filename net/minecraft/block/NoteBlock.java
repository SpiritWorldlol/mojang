...
public class NoteBlock extends Block {
   ...
   private BlockState getStateWithInstrument(WorldAccess world, BlockPos pos, BlockState state) {
      Instrument lv = world.getBlockState(pos.up()).getInstrument();
      if (lv.isNotBaseBlock()) {
         return (BlockState)state.with(INSTRUMENT, lv);
      } else {
         Instrument lv2 = world.getBlockState(pos.down()).getInstrument();
         Instrument lv3 = lv2.isNotBaseBlock() ? Instrument.HARP : lv2;
