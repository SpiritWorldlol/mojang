...
public class ChiseledBookshelfBlockEntity extends BlockEntity implements Inventory {
   ...
   public boolean canTransferTo(Inventory hopperInventory, int slot, ItemStack stack) {
      return hopperInventory.containsAny((arg3) -> {
         if (arg3.isEmpty()) {
            return true;
         } else {
            return ItemStack.canCombine(stack, arg3) && arg3.getCount() + stack.getCount() <= Math.min(arg3.getMaxCount(), hopperInventory.getMaxCountPerStack());
         }
      });
   }
