...
public class SculkShriekerBlock extends BlockWithEntity implements Waterloggable {
   ...
   public BlockEntityTicker getTicker(World world, BlockState state, BlockEntityType type) {
      return !world.isClient ? BlockWithEntity.checkType(type, BlockEntityType.SCULK_SHRIEKER, (arg, pos, statex, arg4) -> {
         Vibrations.Ticker.tick(arg, arg4.getVibrationListenerData(), arg4.getVibrationCallback());
      }) : null;
   }
