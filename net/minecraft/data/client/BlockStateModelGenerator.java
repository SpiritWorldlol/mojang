...
public class BlockStateModelGenerator {
   ...
   public void method_51463(Block arg) {
      TextureMap lv = (new TextureMap()).put(TextureKey.PARTICLE, TextureMap.getSubId(arg, "_particle")).put(TextureKey.DOWN, TextureMap.getSubId(arg, "_down")).put(TextureKey.UP, TextureMap.getSubId(arg, "_up")).put(TextureKey.NORTH, TextureMap.getSubId(arg, "_north")).put(TextureKey.SOUTH, TextureMap.getSubId(arg, "_south")).put(TextureKey.EAST, TextureMap.getSubId(arg, "_east")).put(TextureKey.WEST, TextureMap.getSubId(arg, "_west"));
      this.blockStateCollector.accept(createSingletonBlockState(arg, Models.CUBE.upload(arg, lv, this.modelCollector)));
   }
   ...
   private void registerSculkSensor() {
      ...
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.SCULK_SENSOR).coordinate(BlockStateVariantMap.create(Properties.SCULK_SENSOR_PHASE).register((phase) -> {
         return BlockStateVariant.create().put(VariantSettings.MODEL, phase != SculkSensorPhase.ACTIVE && phase != SculkSensorPhase.COOLDOWN ? lv : lv2);
      })));
   }
