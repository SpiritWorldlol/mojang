...
public class VanillaHusbandryTabAdvancementGenerator implements AdvancementTabGenerator {
   ...
   public void accept(RegistryWrapper.WrapperLookup lookup, Consumer exporter) {
      ...
      Advancement lv13 = Advancement.Builder.create().parent(lv).display((ItemConvertible)Items.SNIFFER_EGG, Text.translatable("advancements.husbandry.obtain_sniffer_egg.title"), Text.translatable("advancements.husbandry.obtain_sniffer_egg.description"), (Identifier)null, AdvancementFrame.TASK, true, true, true).criterion("obtain_sniffer_egg", (CriterionConditions)InventoryChangedCriterion.Conditions.items(Items.SNIFFER_EGG)).build(exporter, "husbandry/obtain_sniffer_egg");
      Advancement lv14 = Advancement.Builder.create().parent(lv13).display((ItemConvertible)Items.TORCHFLOWER_SEEDS, Text.translatable("advancements.husbandry.feed_snifflet.title"), Text.translatable("advancements.husbandry.feed_snifflet.description"), (Identifier)null, AdvancementFrame.TASK, true, true, true).criterion("feed_snifflet", (CriterionConditions)PlayerInteractedWithEntityCriterion.Conditions.create(ItemPredicate.Builder.create().tag(ItemTags.SNIFFER_FOOD), EntityPredicate.Extended.ofLegacy(EntityPredicate.Builder.create().type(EntityType.SNIFFER).flags(EntityFlagsPredicate.Builder.create().isBaby(true).build()).build()))).build(exporter, "husbandry/feed_snifflet");
      Advancement.Builder.create().parent(lv14).display((ItemConvertible)Items.PITCHER_POD, Text.translatable("advancements.husbandry.plant_any_sniffer_seed.title"), Text.translatable("advancements.husbandry.plant_any_sniffer_seed.description"), (Identifier)null, AdvancementFrame.TASK, true, true, true).criteriaMerger(CriterionMerger.OR).criterion("torchflower", (CriterionConditions)PlacedBlockCriterion.Conditions.block(Blocks.TORCHFLOWER_CROP)).criterion("pitcher_pod", (CriterionConditions)PlacedBlockCriterion.Conditions.block(Blocks.PITCHER_CROP)).build(exporter, "husbandry/plant_any_sniffer_seed");
   }
